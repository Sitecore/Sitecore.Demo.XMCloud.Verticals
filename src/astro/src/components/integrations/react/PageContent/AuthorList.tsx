              ...
              >
                ...
                <div className="col-lg-8">
                  ...
                  <div className="d-flex flex-wrap gap-3 justify-content-between align-items-center">
                    <Link field={author} className="button button-secondary">
                      Read More
        ...
        >
          {authors?.map((author) => (
            <SwiperSlide key={author.url}>
              <Link field={author} className="wrapper-link">
                <Image field={author.fields.Photo} />
          ...
          {authors?.map((author) => (
            <div key={author.url} className="col-sm-5 col-lg-3">
              ...
              <div>
                ...
                <Link field={author} href={author.url} className="button button-simple">
                  {/* {t('Read more') || 'Read more'} */}
                </Link>
              </div>
            </div>
